import { CELL, LABEL_WIDTH, KB_GAP, KEYS_PER_ROW, HEADER_HEIGHT, WATERMARK_H, TITLE_LINE_H, DIAG_CELL, DIAG_GAP, NUM_CONTROLLERS, NUM_SLOTS, TITLE_LINES, } from "./config.js";
...
export const DIAG_COLS = [2, 3, 5];
export const DIAG_COL_LABELS = ["Xbox", "PlayStation", "Switch"];
...
export const LABELED = {
    ...
    height: Math.max(titleBannerH + HEADER_HEIGHT + NUM_SLOTS * CELL, LBL_diagSectionY + HEADER_HEIGHT + DIAG_COLS.length * (HEADER_HEIGHT + DIAG_CELL)) + WATERMARK_H,
...
export const CLEAN = {
    ...
    height: Math.max(NUM_SLOTS * CELL, CLN_diagSectionY + DIAG_COLS.length * DIAG_CELL),
