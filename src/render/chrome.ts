import {
    TITLE_LINES, WATERMARK_TEXT,
    LABEL_WIDTH, CELL, HEADER_HEIGHT, WATERMARK_H, TITLE_LINE_H,
    DIAG_CELL, DIAG_GAP, NUM_CONTROLLERS, NUM_SLOTS, KB_GAP,
} from "../config.js";
import { CONTROLLER_LABELS, SLOT_LABELS } from "../data/controllers.js";
import {
    kbSectionWidth, kbRows, ctrlSectionW,
    titleBannerH, LBL_KB_X, LBL_ctrlVBase, LBL_diagSectionY, LBL_kbVBase,
    DIAG_COL_LABELS, LABELED,
} from "../layout.js";
import { hRule, vRule, shadowPrint, type Font, type JimpImage } from "./primitives.js";

export function renderTitleBanner(atlas: JimpImage, fontW: Font, fontB: Font): void {
...
export function renderSectionSeparator(atlas: JimpImage): void {
    const sepX = LABEL_WIDTH + ctrlSectionW + Math.floor(KB_GAP / 2);
    vRule(atlas, sepX, titleBannerH, LBL_diagSectionY);
}

export function renderControllerChrome(atlas: JimpImage, fontW: Font, fontB: Font): void {
...
export function renderKeyboardChrome(atlas: JimpImage, fontW: Font, fontB: Font): void {
...
export function renderDiagramsChrome(atlas: JimpImage, fontW: Font, fontB: Font): void {
...
export function renderWatermark(atlas: JimpImage, fontSmallW: Font, fontSmallB: Font): void {
